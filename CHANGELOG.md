...
- WebUI 将 RTX 4090 标记为推荐，RTX 5080M 保留为实验性对照项。
- 补充实测结论：RTX 4090 可正常显示“光线追踪”选项；RTX 5080M 目前只能看到“全景光追”和“关”。
- 补充游戏内画质预设说明：光追选项通常需要默认预设在“极致”或以上才出现，切到自定义低端配置后选项可能消失但效果可能保留。
